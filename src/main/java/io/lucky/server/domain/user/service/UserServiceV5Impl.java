...
@Slf4j
@Service
public class UserServiceV5Impl implements UserServiceV2 {
    ...
    public UserServiceV5Impl(PlatformTransactionManager transactionManager, UserRepositoryV3Impl userRepository) {
